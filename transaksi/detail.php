		...
		<div class="col-md-7">
			...
			<table class="table table-bordered">
				<tr>
					...
					<td><?=date('d F Y ', strtotime($detail['judul']))?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<strong>Denda yang harus dibayar;</strong>Rp<?=$denda?></td>
				</tr>
				<?php
				}
				?>
				<tr>
					<td class="text-right" colspan="2">
						<a href="index.php" class="btn bnt-success"><i class="fas fa-angle-double-left"></i>Kembali</a>
						<a class="btn btn-primary<?php
						if($detail['tgl_kembali']!=NULL) {echo "disabled";}?>" href="form-kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_buku=<?=$detail['id_buku']?>" role="button">Form Pengembalian</a>
					</td>
				</tr>
			</table>
		</div>
